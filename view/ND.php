...
<head>
   <meta charset="utf-8">
    ...
    <h3 align="">Register a New Natural Disaster Report</h3><br />
</head>
<body onload = "getLocation();">
  
    
    <form class= "myForm" method="post" action="../controller/NDAction.php" autocomplete="off">   


      <label for = "category">Choose Category:</label><br>
      <input type="radio" name="category"   value="Food"> Food
      <input type="radio" name="category"   value="Shelter"> Shelter 
      <input type="radio" name="category"   value="Rescue"> Rescue
      <br><br>
...
<br>
<a href="NDMap.php">Database Page</a>
